...
def get_args():
    ...
    parser.add_argument('--id_dataset', type=str, default='AIDS',
                        choices=['BZR', 'PTC-MR', 'AIDS', 'ENZYMES', 'IMDB-MULTI', 'Tox21', 'FreeSolv',
                                 'BBPB', 'ClinTox', 'Esol', ],
                        help='ID dataset name (known classes for training)')
    parser.add_argument('--ood_dataset', type=str, default='DHFR',
    ...
    parser.add_argument('--num_atom_supp', type=int, default=65,
    ...
    parser.add_argument('--w_atom', type=float, default=0.432845022129388,
                        help='Atom distance loss weight')
    parser.add_argument('--w_pos', type=float, default=4.123206532618725,
                        help='Positive sample distance loss weight')
    parser.add_argument('--w_neg', type=float, default=1.752410111812814,
